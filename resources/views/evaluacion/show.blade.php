...
<?php use App\Models\User; ?>
    ...
    <script>
        ...
        for (let i = 0; i < valorInput.length; i++) {
            console.log("Pregunta " + valorInput[i].num + ": " + valorInput[i].preg);

            for (let j = 0; j < valorInput[i].alternativas.length; j++) {
                console.log("Alternativa " + (j + 1) + ": " + valorInput[i].alternativas[j].alter);
            }

            console.log("Respuesta correcta: " + valorInput[i].respuestaCorrecta);
        }*/
