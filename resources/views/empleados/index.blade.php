        ...
        <tbody>
            @foreach ($empleados as $empleado)
                <tr>
                    ...
                    <td>
                        @if ($empleado->Foto == "")
                            <img class="zz_image" src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp"
                            alt="avatar" class="rounded-circle img-fluid" width="70px" alt="" >
                        @else
