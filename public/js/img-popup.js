(function ($) {
    ...
    var button_zoom = $('<div class="zz_controls"><button type="button" class="zz_zoom-in">+Agrandar</button><button type="button" class="zz_zoom-out">-Alejar</button></div>');
    var media = $('<img src="" />');
    ...
    $('body').on('click', '.zz_zoom-in', function(e) {
        ...
        if(img !== 'undefined') {
            ...
            if(cW >= zLW){
                alert("Ya no se puede agrandar más la imagen.");
            } else{
    ...
    $('body').on('click', '.zz_zoom-out', function(e) {
        ...
        if(img !== 'undefined') {
            ...
            if(cW <= zLW){
                alert("Ya no se puede alejar más la imagen.");
            } else{
                myImg.innerWidth((cW - 50) + "px");
